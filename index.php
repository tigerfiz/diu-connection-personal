...
if (isset($_POST['login'])) {
    ...
    $catch_username = $username_send->fetch_assoc();


    if ($username_send->num_rows > 0) {

        $_SESSION['username'] = $catch_username['username'];
        $_SESSION['fullname'] = $catch_username['fullname'];
        $_SESSION['Department'] = $catch_username['Department'];
    ...
    <section class="total">
        <div class="innertotal">
            ...
            <div class="content">
                ...
                <form class="contentinner" action="index.php" method="POST">
